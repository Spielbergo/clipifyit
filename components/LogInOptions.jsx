      ...
      <div className={styles.container}>
        ...
        {showForgot ? (
          <form className={styles.form} onSubmit={handleForgotPassword}>
            ...
            {forgotSent && (
              <div className={styles.notification} style={{ marginTop: 8 }}>
          ...
          <form className={styles.form} onSubmit={handleEmailLogin}>
            ...
            {!isSignUp && (
              <button
                type="button"
                className={styles.switchBtn}
                style={{ marginTop: 8, fontSize: 13, background: 'none', color: '#6599a6', textDecoration: 'underline', border: 'none', boxShadow: 'none' }}
                onClick={() => {
                  setShowForgot(true);
                  setForgotEmail("");
                  setForgotSent(false);
